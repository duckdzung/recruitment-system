...
public class InputValidator {
    // 8 characters or more, at least 1 uppercase letter, lowercase letter, number, and special character
    ...
    private static final Pattern usernamePattern = Pattern.compile("^[a-zA-Z0-9_]{5,30}$");
